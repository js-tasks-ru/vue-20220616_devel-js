<template>
  <fieldset class="agenda-item-form">
    ...
    <ui-form-group v-for="(item, key, idx) in formByType" :key="idx" :label="item.label">
      <component :is="item.component" v-bind="item.props" v-model="localAgendaItem[key]" :name="key" />
    </ui-form-group>
  </fieldset>
</template>
